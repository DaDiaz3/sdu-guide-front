...
import BlockDRight from "../Components/assets/blockspng/BlockDimages/BlockDRight.png";
        ...
        <div className="min-h-screen font-[Cormorant] bg-[#F8F8F8] text-black">
            ...
            <main>
                ...
                <section className="w-full flex justify-center py-12 px-8 bg-white rounded-lg shadow-lg relative">
                    {/* Картинка */}
                    <img src={BlockDRight} alt="Campus Map" className="w-[80%] max-w-[1200px] rounded-lg shadow-md"/>
